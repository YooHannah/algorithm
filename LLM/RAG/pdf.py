...
from embeddingsSearch import get_embeddings
...
# pdf2images("/Users/bytedance/project/LLM/RAG/llama2_page8.pdf")
# show_images("/Users/bytedance/project/LLM/RAG/llama2_page8")
...
def detect_and_crop_save_table(file_path):
    ...
    # 识别表格 (用上面tramsformer AutoModelForObjectDetection 生成的模型)
    with torch.no_grad():
...
# detect_and_crop_save_table("/Users/bytedance/project/LLM/RAG/llama2_page8/page_1.png")
# show_images("/Users/bytedance/project/LLM/RAG/llama2_page8/table_images")


# <!--基于 GPT-4 Vision API 做表格问答-->
# 图片转成base64的方式输入给大模型, 注意图片是怎么入参的
...
# response = image_qa("哪个模型在AGI Eval数据集上表现最好。得分多少","/Users/bytedance/project/LLM/RAG/llama2_page8/table_images/page_1_0.png")
# print(response)
...
images = []
dir_path = "/Users/bytedance/project/LLM/RAG/llama2_page8/table_images"
for file in os.listdir(dir_path):
    if file.endswith('.png'):
        # 打开图像
