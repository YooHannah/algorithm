...
"""
# 创建orders表
cursor.executescript(database_schema_string)
...
for record in mock_data:
    ...
    ''', record)
mock_customer = [
    (1001, 'John Doe', 'EMAIL1001', '2023-01-01 10:00:00'),
    (1002, 'Jane Smith', 'EMAIL1002', '2023-01-01 17:00:00'),
    (1003, 'Bob Johnson', 'EMAIL1003', '2023-01-01 19:00:00'),
]
for customer in mock_customer:
    cursor.execute('''
...
mock_product = [
    ('TSHIRT_1','TSHIRT_1', 50.00),
    ('TSHIRT_2', 'TSHIRT_2', 75.50),
    ('SHOES_X2', 'SHOES_X2', 25.25),
    ('HAT_Z112', 'HAT_Z112', 60.75),
    ('WATCH_X001', 'WATCH_X001', 90.00)
]
...
def get_sql_completion(messages, model="gpt-3.5-turbo"):
    ...
    print('get_sql_completion response')
    print_json(response)
